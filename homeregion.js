...
exports.generateHomeregion = void 0;
var race_1 = require("./race");
var diceRoller_1 = require("./diceRoller");
function generateHomeregion() {
    createHomeregions();
    var tempRegion = heimatregion[race_1.raceInt];
    return tempRegion[diceRoller_1.d6Roller() - 1];
}
exports.generateHomeregion = generateHomeregion;
var heimatregion = [];
